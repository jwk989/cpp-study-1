/*
2-a) Write a class named Average that will keep track of the average of all integers passed to it. 
...
The second should be of type std::int8_t, and used to keep track of how many numbers you’ve seen so far. 
